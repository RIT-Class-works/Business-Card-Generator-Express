...
const router = (app) => {
  ...
  app.post('/purchase', mid.requiresSecure, mid.requiresLogin, controllers.Account.makePurchase);
  app.post('/passwordChange', mid.requiresSecure, mid.requiresLogin, controllers.Account.changePass);
  app.get('/account', mid.requiresSecure, controllers.Account.getPurchased);
